...
# USAGE:
#/video-spliter.sh s4_linear_regresion.mov 80000000 "-c:v libx264 -crf 23 -c:a copy -vf pad=ceil(iw/2)*2:ceil(ih/2)*2"

#OR 

#./video-spliter.sh s4_linear_regresion.mov 80000000 "-c:v libx264 -crf 23 -c:a copy -vf scale=960:-1"
