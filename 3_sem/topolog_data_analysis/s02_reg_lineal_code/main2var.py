...
def main():
    ...
    grad_descent(data_area, "Area", data_price, beta_0, beta_1, max_iteration, learning_rate)
    ...
    grad_descent(data_age, "Age", data_price, beta_0, beta_1, max_iteration, learning_rate)
