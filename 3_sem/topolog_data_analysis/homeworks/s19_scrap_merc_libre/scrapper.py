...
def pull_details(url_product:str):
    ...
    specs = soup.find_all("li",{"class":"ui-vpp-highlighted-specs__features-list-item ui-pdp-color--BLACK ui-pdp-size--XSMALL ui-pdp-family--REGULAR"})
    
    for u in range(0, len(specs)):
        specs_obj[u]=specs[u].text.lstrip().rstrip()
